...
<div class="box">
	<h3>添加房屋信息</h3>
	<form action="houseAdd.do" method="post">
	<table class="form-table">
		...
		<tr>
			<td>小区名字</td>
			<td colspan="3" class="control">
				<input type="text" name="hEstate" placeholder="小区名字">
			</td>
		</tr>
		<tr>
			<td>单元号</td>
			<td colspan="3" class="control">
				<input type="text" name="hUnIntegerNumber" placeholder="单元号">
			</td>
		</tr>
		<tr>
			<td>楼层</td>
		...
		<tr>
			<td>朝向</td>
			<td colspan="3" class="control">
				<input type="text" name="hDirection" placeholder="朝向">
			</td>
		</tr>
		<tr>
			<td>装修</td>
			<td colspan="3" class="control">
				<input type="text" name="hFitment" placeholder="装修">
			</td>
		</tr>
		<tr>
			<td>是否双气</td>
			<td colspan="3" class="control">
				<input type="text" name="hIsdoubleair" placeholder="是否双气">
			</td>
		</tr>
		<tr>
			<td>限住人数</td>
		...
		<tr>
			<td>房屋图片</td>
			<td colspan="3" class="control">
				<input type="file" name="hImg" placeholder="">
			</td>
		</tr>
		<tr>
			<td>完整地址信息</td>
